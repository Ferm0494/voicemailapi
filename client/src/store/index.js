...
const AllReducers = combineReducers({app: appReducer, voiceMails: voiceMailsReducer,anchorEl: anchorElReducer,vmBoxes: vmBoxesReducer,anchorEl2: anchorElReducer2})
const InitialStates = {
        vmBoxes:[],
